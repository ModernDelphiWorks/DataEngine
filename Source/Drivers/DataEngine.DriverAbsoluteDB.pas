...
procedure TDriverAbsoluteDB._InternalExecuteDirect(const ASQL: String; const AParams: TParams);
var
  LExeSQL: TABSQuery;
  LFor: Integer;
begin
...
procedure TDriverQueryAbsoluteDB._InternalExecuteDirect;
var
  LExeSQL: TABSQuery;
  LFor: Integer;
begin
...
function TDriverQueryAbsoluteDB._InternalExecuteQuery: IDBDataSet;
var
  LDataSet: TABSQuery;
  LFor: Integer;
begin
...
function TDriverQueryAbsoluteDB._GetParams: TParams;
var
  LFor: Int16;
begin
...
procedure TDriverQueryAbsoluteDB.Prepare;
begin
  FSQLQuery.Prepare;
end;

procedure TDriverQueryAbsoluteDB.Unprepare;
begin
  FSQLQuery.Unprepare;
end;

function TDriverQueryAbsoluteDB.ParamByName(const AValue: string): TParam;
begin
