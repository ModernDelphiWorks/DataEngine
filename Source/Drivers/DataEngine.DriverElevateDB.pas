...
procedure TDriverElevateDB._InternalExecuteDirect(const ASQL: String; const AParams: TParams);
var
  LExeSQL: TEDBQuery;
  LFor: Integer;
begin
...
procedure TDriverQueryElevateDB._InternalExecuteDirect;
var
  LExeSQL: TEDBQuery;
  LFor: Integer;
begin
...
function TDriverQueryElevateDB._InternalExecuteQuery: IDBDataSet;
var
  LDataSet: TEDBQuery;
  LFor: Integer;
begin
...
function TDriverQueryElevateDB._GetParams: TParams;
var
  LFor: Int16;
begin
...
procedure TDriverQueryElevateDB.Prepare;
begin
  FSQLQuery.Prepare;
end;

procedure TDriverQueryElevateDB.Unprepare;
begin
  FSQLQuery.Unprepare;
end;

function TDriverQueryElevateDB.ParamByName(const AValue: string): TParam;
begin
