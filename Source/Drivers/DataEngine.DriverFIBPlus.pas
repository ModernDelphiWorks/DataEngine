...
procedure TDriverFIBPlus._InternalExecuteDirect(const ASQL: String; const AParams: TParams);
var
  LExeSQL: TFIBQuery;
  LFor: Int16;
begin
...
function TDriverQueryFIBPlus._InternalExecuteQuery: IDBDataSet;
var
    ...
    try
      ...
      begin
         if LDataSet.RecordCount = 0 then
           (Result as TDriverDataSetFIBPlus).FetchingAll := True;
      end;
    except
      on E: EDatabaseError do
      begin
...
procedure TDriverQueryFIBPlus._InternalExecuteDirect;
var
  LExeSQL: TFIBQuery;
  LFor: Int16;
begin
...
function TDriverQueryFIBPlus._GetParams: TParams;
var
  LFor: Int16;
begin
...
procedure TDriverQueryFIBPlus.Prepare;
begin
  FSQLQuery.Prepare;
end;

procedure TDriverQueryFIBPlus.Unprepare;
begin
  // FIBPlus might not have explicit unprepare in all versions, or is handled by Close
end;

function TDriverQueryFIBPlus.ParamByName(const AValue: string): TParam;
begin
  Result := FSQLQuery.Params.ParamByName(AValue);
end;
