...
procedure TDriverMongoFireDAC._InternalExecuteDirect(const ASQL: String; const AParams: TParams);
var
  LCommand: String;
begin
  try
...
function TDriverQueryMongoFireDAC._InternalExecuteQuery: IDBDataSet;
var
  ...
  try
    ...
    try
      ...
      if LResultSet.Active and (LResultSet.RecordCount = 0) then
        (Result as TDriverResultSetMongoFireDAC).FetchingAll := True;
    except
      on E: Exception do
      begin
...
procedure TDriverQueryMongoFireDAC._InternalExecuteDirect;
begin
