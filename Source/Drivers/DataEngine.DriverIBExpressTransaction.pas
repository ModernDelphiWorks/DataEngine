...
constructor TDriverIBExpressTransaction.Create(const AConnection: TComponent; const AMonitorCallback: TMonitorProc);
var
...
procedure TDriverIBExpressTransaction.StartTransaction(const ALevel: TDBIsolationLevel);
begin
