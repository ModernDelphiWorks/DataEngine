...
procedure TDriverIBObjects._InternalExecuteDirect(const ASQL: String; const AParams: TParams);
var
  LExeSQL: TIBOQuery;
  LFor: Integer;
begin
...
procedure TDriverQueryIBObjects._InternalExecuteDirect;
var
  LExeSQL: TIBOQuery;
  LFor: Integer;
begin
...
function TDriverQueryIBObjects._InternalExecuteQuery: IDBDataSet;
var
  LDataSet: TIBOQuery;
  LFor: Integer;
begin
...
function TDriverQueryIBObjects._GetParams: TParams;
var
  LFor: Int16;
begin
...
procedure TDriverQueryIBObjects.Prepare;
begin
  FSQLQuery.Prepare;
end;

procedure TDriverQueryIBObjects.Unprepare;
begin
  FSQLQuery.Unprepare;
end;

function TDriverQueryIBObjects.ParamByName(const AValue: string): TParam;
begin
