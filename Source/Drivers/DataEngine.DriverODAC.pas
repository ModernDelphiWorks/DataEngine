...
procedure TDriverODAC._InternalExecuteDirect(const ASQL: String; const AParams: TParams);
var
  LExeSQL: TOraQuery;
  LParams: TParams;
  LFor: Int16;
...
function TDriverQueryODAC._InternalExecuteQuery: IDBDataSet;
var
  LDataSet: TOraQuery;
  LParams: TParams;
  LFor: Int16;
    ...
    try
      ...
      begin
         if LDataSet.RecordCount = 0 then
           (Result as TDriverDataSetODAC).FetchingAll := True;
      end;
    except
      on E: EDatabaseError do
      begin
...
function TDriverQueryODAC._GetParams: TParams;
var
  LFor: Int16;
begin
...
procedure TDriverQueryODAC.Prepare;
begin
  FSQLQuery.Prepare;
end;

procedure TDriverQueryODAC.Unprepare;
begin
  FSQLQuery.Unprepare;
end;

function TDriverQueryODAC.ParamByName(const AValue: string): TParam;
begin
...
procedure TDriverQueryODAC._InternalExecuteDirect;
var
  LExeSQL: TOraQuery;
  LFor: Int16;
begin
