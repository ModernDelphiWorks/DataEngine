...
procedure TDriverSQLdb._InternalExecuteDirect(const ASQL: String; const AParams: TParams);
var
  LExeSQL: TSQLQuery;
  LFor: Integer;
begin
  ...
  try
    ...
    try
      if Assigned(AParams) and (AParams.Count > 0) and (not LExeSQL.Prepared) then
        LExeSQL.Prepare;
      LExeSQL.ExecSQL;
...
procedure TDriverQuerySQLdb._InternalExecuteDirect;
var
  LExeSQL: TSQLQuery;
  LFor: Integer;
begin
...
function TDriverQuerySQLdb._InternalExecuteQuery: IDBDataSet;
var
  LDataSet: TSQLQuery;
  LFor: Integer;
begin
...
function TDriverQuerySQLdb._GetParams: TParams;
var
  LFor: Int16;
begin
...
procedure TDriverQuerySQLdb.Prepare;
begin
  FSQLQuery.Prepare;
end;

procedure TDriverQuerySQLdb.Unprepare;
begin
  FSQLQuery.Unprepare;
end;

function TDriverQuerySQLdb.ParamByName(const AValue: string): TParam;
begin
