...
constructor TDriverWireMongoDBTransaction.Create(const AConnection: TComponent; const AMonitorCallback: TMonitorProc);
begin
...
procedure TDriverWireMongoDBTransaction.StartTransaction(const ALevel: TDBIsolationLevel);
begin
