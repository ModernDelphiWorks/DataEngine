...
uses
  ...
  SysUtils,
  Data.DB,
  DBEngine.DataEngine.FactoryInterfaces,
  DBEngine.DataEngine.DriverMemory,
  DBEngine.DataEngine.DriverMemoryTransaction,
  DBEngine.DataEngine.FactoryMemory;
...
var
  ...
  LQuery: IDBQuery;
begin
  // Dados j� s�o inseridos na mesma conex�o mantida por FDBConnection
